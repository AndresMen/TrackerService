package com.example.mendez.trackerservice.widget;
...
public class miLayout extends FrameLayout {
    ...
    public miLayout (Context context) {
        super(context);
        init(context, null, 0, 0);
    }

    public miLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, 0);
    }

    public miLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, 0);
    }

    @RequiresApi(api = 21)
    public miLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
